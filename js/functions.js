(function ($) {
	...
	var $menu = $("nav#menu").mmenu({
		...
		navbars: [{position:'bottom',content: ['<span>© ' + new Date().getFullYear() + ' ' + document.getElementById("logo").getElementsByTagName('a')[0].title + '</span>']}]},
		{
		// configuration
		clone: true,
		classNames: {
    ...
    $('#carousel_inicial_blog').owlCarousel({
        items: 2,
        margin: 10,
        slideBy: 2,
        loop: true,
	...
	$('#carousel_localizacao_estados').owlCarousel({
        items: 2,
        margin: 10,
        slideBy: 2,
        loop: true,
