    ...
    function exibirPaginacao() {
        ...
        if (totalPages > 1) {
            ...
            if (paginaAtual > 1) {
                ...
                prevPageLink.href = paginaAtual === 2 ? `?slug=${slugDaPagina}` : `?slug=${slugDaPagina}&pagina=${paginaAtual - 1}`;
            ...
            for (let i = 1; i <= totalPages; i++) {
                ...
                pageLink.href = i === 1 ? `?slug=${slugDaPagina}` : `?slug=${slugDaPagina}&pagina=${i}`;
            ...
            if (paginaAtual < totalPages) {
                ...
                nextPageLink.href = `?slug=${slugDaPagina}&pagina=${paginaAtual + 1}`;
